...
The problem I ran into using this method was when I tried to place the tables on the page, especially in relation to other elements, like a `pandoc.table`. I wasn't satisfied with the results, so I decided to pursue other options.
